...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-EPICday/FastttCamera.framework"
  install_framework "Pods-EPICday/Firebase.framework"
  install_framework "Pods-EPICday/FormatterKit.framework"
  install_framework "Pods-EPICday/GPUImage.framework"
  install_framework "Pods-EPICday/NYTPhotoViewer.framework"
